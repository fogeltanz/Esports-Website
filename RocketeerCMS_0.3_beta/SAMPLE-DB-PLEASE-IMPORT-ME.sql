...
# Database: blueprint
# Generation Time: 2013-04-15 14:42:55 +0000
# ************************************************************
...
CREATE TABLE `forum_posts` (
  ...
  `updated_at` int(11) DEFAULT NULL,
  `content` text NOT NULL,
  `article_sync` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `forum_posts` (`id`, `thread_id`, `user_id`, `created_at`, `updated_at`, `content`, `article_sync`)
VALUES
	(1,1,1,1365509642,1365509642,'Hello, this is an example forum thread, in here I like to talk about my favourite things and allow you to reply with your own opinions.',NULL),
	(2,1,1,1366029806,1366029806,'This is a follow up post. Love it.&nbsp;<div><br></div><div>Thing\'s like quoting is coming soon. One step at a time eh?!</div>',NULL);

/*!40000 ALTER TABLE `forum_posts` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table forum_sections
# ------------------------------------------------------------
...
INSERT INTO `forum_sections` (`id`, `name`, `url_name`, `description`, `position`, `order`, `private`)
VALUES
	(1,'Forum Section Example','Forum-Section-Example','',NULL,0,0);
...
CREATE TABLE `forum_threads` (
  ...
  `view_count` decimal(11,0) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `forum_threads` (`id`, `title`, `url_title`, `is_sticky`, `created_at`, `updated_at`, `user_id`, `forum_id`, `forum_posts_number`, `sticky`, `closed`, `view_count`)
VALUES
	(1,'This is an example forum thread','This-is-an-example-forum-thread',NULL,1365509642,1366029806,1,1,2,1,0,37);
...
CREATE TABLE `forums` (
  ...
  `icon_mime` varchar(40) NOT NULL,
  `icon_size` int(11) NOT NULL,
  `icon_path` text,
  `icon_thumb_url` varchar(255) NOT NULL,
  `icon_thumb_path` text NOT NULL,
  `position` tinyint(4) DEFAULT NULL,
...
INSERT INTO `forums` (`id`, `section_id`, `parent_id`, `order`, `name`, `url_name`, `description`, `icon_url`, `icon_filename`, `icon_mime`, `icon_size`, `icon_path`, `icon_thumb_url`, `icon_thumb_path`, `position`, `forum_threads_number`)
VALUES
	(1,1,0,0,'This is an example forum','This-is-an-example-forum','<p>This is an example forum description that should give you an idea of what to talk about within.</p>','/uploads/icons/','','',0,'./uploads/icons/','','',NULL,1);
...
VALUES
	('861dc0453c0ee8e4324c44f223ae0582','127.0.0.1','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_3) App',1365603116,'a:2:{s:15:\"_facebook_scope\";s:0:\"\";s:18:\"_facebook_callback\";s:23:\"http://rocketeer.basic/\";}'),
	('90e47a882c8a14986c0e225c83db7384','127.0.0.1','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_3) App',1366036732,'a:7:{s:15:\"_facebook_scope\";s:0:\"\";s:18:\"_facebook_callback\";s:23:\"http://rocketeer.basic/\";s:5:\"email\";s:15:\"admin@admin.com\";s:2:\"id\";s:1:\"1\";s:7:\"user_id\";s:1:\"1\";s:8:\"group_id\";s:1:\"1\";s:5:\"group\";s:6:\"admins\";}');
...
VALUES
	(1,1,'127.0.0.1','Admin','97132b3bb7c5efd2a3daf34d281ea03cbcdedb18','GB','2ee07423e2','admin@admin.com','',NULL,'ab367a18d95eca5f251a8fc3e2faa7f17d86ac4d',1342481356,1366029770,1,'/uploads/user_avatars/avatar2.png','/uploads/user_avatars/avatar2_thumb.png','/Users/Gavin/Sites/Rocketeer Basic//uploads/user_avatars/avatar2_thumb.png','avatar2.png','image/png',8,'/Users/Gavin/Sites/Rocketeer Basic/uploads/user_avatars/avatar2.png','Europe/London',3,1,2);
